...
<div class="flex justify-center pt-8 pb-16">
    <div class="w-full max-w-md px-4">
        <div class="mb-6 text-left">
            <h1 class="text-4xl font-display font-bold text-gray-900 tracking-tight">Přihlášení</h1>
            <p class="mt-2 text-sm text-gray-500 font-medium">Vítej zpět! Přihlas se ke svému účtu.</p>
        ...
        <div class="bg-white p-8 sm:p-10 rounded-[2rem] border border-gray-200 shadow-md">
            ...
            <div>
                <label for="email" class="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">E-mail</label>
            ...
            <div>
                <label for="password" class="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">Heslo</label>
                <div class="relative">
            ...
            <button type="submit"
                    class="w-full py-3.5 mt-2 bg-gray-900 text-white text-sm font-bold rounded-xl hover:bg-gray-800 hover:scale-105 hover:shadow-lg transition-all uppercase tracking-wider">
                Přihlásit se
            </button>
        </form>
        ...
        <p class="mt-8 text-sm text-center text-gray-500 font-medium">
            Nemáš ještě účet?
            <a href="<?= BASE_URL ?>/index.php?url=auth/register" class="text-gray-900 font-bold hover:underline">Registruj se</a>
        </p>
        </div>
    </div>
</div>
